module.exports = function(req,res){
    ...
    h += '<br>ie <a href="https://helloroute.herokuapp.com/jonas" target="_blank">https://helloroute.herokuapp.com/jonas</a>,<br>&nbsp;&nbsp;&nbsp; <a href="https://helloroute.herokuapp.com/wade" target="_blank">https://helloroute.herokuapp.com/wade</a>,<br>&nbsp;&nbsp;&nbsp; <a href="https://helloroute.herokuapp.com/paul" target="_blank">https://helloroute.herokuapp.com/paul</a>,<br>&nbsp;&nbsp;&nbsp; etc ...'
    h += '</p>'
    h += '</div>'
    res.send(h)
}
